...
parser.add_option("-d", "--duration",
                  dest="duration", type='int', default=15, # originally 200
...
# I just need to create a markers stream I think, and just run BlueMuse or ```muselsl stream``` like I've been doing while this runs.